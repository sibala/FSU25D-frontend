...
## 1. JS intro
- Study the code in [js-intro](js-intro) 
- Read [Introduction to pseudocode and flowcharts](intro-pseudocode-flowcharts.pdf) 
...
- [JS Data Types](https://www.w3schools.com/js/js_datatypes.asp) *(We'll cover arrays and objects later in the course)*
